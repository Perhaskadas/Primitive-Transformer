...
class Transformer(nn.Module):
    ...
    def __init__(self, heads: int, ffn_hidden: int, layers: int, vocab_size1: int, vocab_size2: int, 
        ...
        encoder_embedding = nn.Embedding(vocab_size1, model)
        decoder_embedding = nn.Embedding(vocab_size2, model)
